    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border">
                <div class="card-header"><h4>Sửa bài viết</h4></div>
                        ...
                        @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 border">
                                    <input autocomplete="off" type="text" class="form-control" name="blog_name" value="{{$blog->blog_name}}" onkeyup="ChangeToSlug();" id="slug">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="blog_slug" class="col-md-4 col-form-label text-md-right">Slug bài viết:</label>
                                <div class="col-md-6 border">
                                    <input autocomplete="off" type="text" class="form-control" name="blog_slug" value="{{$blog->blog_slug}}" id="convert_slug" >
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-2">
                                <img src="{{ asset('uploads/'.$blog->blog_image) }}" alt="" height="100">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="blog_author" class="col-md-4 col-form-label text-md-right">Tác giả:</label>
                                <div class="col-md-6 border">
                                    <input autocomplete="off" type="text" class="form-control" name="blog_author" value="{{$blog->blog_author}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="blog_desc" class="col-md-4 col-form-label text-md-right">Mô tả:</label>
                                <div class="col-md-12 border">
                                    <textarea id="my-editor" autocomplete="off" class="form-control" name="blog_desc" rows="3" style="resize: none;">{!!$blog->blog_desc!!}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                    ...
                                    <select class="custom-select" name="cate_blog_slug">
                                      ...
                                      @foreach ($cate_blog as $key => $dulieu)
                                        <option value="{{$dulieu->id}}"
                                            @if ($dulieu->id == $blog->cate_blog_id)
                                               selected 
                                            @endif>

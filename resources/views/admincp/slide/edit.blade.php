    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border">
                <div class="card-header"><h4>Sửa slide</h4></div>
                        ...
                        @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 border">
                                    <input autocomplete="off" type="text" class="form-control" name="slide_name" value="{{$slide->slide_name}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 border">
                                    <textarea autocomplete="off" class="form-control" name="slide_desc" rows="3" style="resize: none;">{{$slide->slide_desc}}</textarea>
                                </div>
                            </div>
